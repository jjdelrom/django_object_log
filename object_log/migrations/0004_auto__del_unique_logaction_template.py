...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'LogAction', fields ['template']
        db.delete_unique('object_log_logaction', ['template'])


    def backwards(self, orm):
        # Adding unique constraint on 'LogAction', fields ['template']
        db.create_unique('object_log_logaction', ['template'])
    ...
    models = {
        ...
        'object_log.logitem': {
            'Meta': {'ordering': "('timestamp',)", 'object_name': 'LogItem'},
